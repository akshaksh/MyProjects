package com.bharath.ws.trainings.ws.client;
...
public class CustomerOrdersWSClient {
	public static void main(String[] args) {
		try {
			//There is a provider working as service provider in behind shown in below line
			CustomerOrdersService service=new CustomerOrdersService(new URL("http://localhost:8089/Apachejws/services/customerOrders?wsdl"));
