...
import com.luv2code.springdemo.exceptionhandling.CustomException;
...
public class CustomerRestController {
	...
	public ResponseEntity<String> updateCustomer(@PathVariable("id")int id,@RequestBody Customer customer) throws CustomException{
	...
	public ResponseEntity<String> deleteCustomer(@PathVariable("id")int id) throws CustomException{
	...
	public ResponseEntity<Customer> getCustomer(@PathVariable("id")int id) throws CustomException{
	...
	public ResponseEntity<ErrorDetail> handleException(HttpServletRequest request){
