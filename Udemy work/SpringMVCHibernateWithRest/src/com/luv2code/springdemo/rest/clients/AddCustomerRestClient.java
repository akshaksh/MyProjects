package com.luv2code.springdemo.rest.clients;
...
public class AddCustomerRestClient {

	public static void main(String[] args) {
		final String url="http://localhost:8082/SpringMVCHibernateWithRest/webservices";
	    ...
	    ResponseEntity<Customer> customer = restTemplate.exchange(url+"/customer/2", HttpMethod.GET, entity, Customer.class);
	    System.out.println(customer.getBody());
	    ResponseEntity<String> result = restTemplate.exchange(url+"/customer/2", HttpMethod.GET, entity, String.class);
